			...
			<c:forEach items="${page.content }" var="page">
				<table width="100%" class="mytab table" cellspacing="0" cellpadding="5">
					<tbody>
					  <tr>
					    <td  class="news_title">
					   			<div class="news_title_limit wordbreak"><a style="color: #2a60a0;"  href="<c:url value="/news/${type }/view/${page.id }"></c:url>"><b>${page.title }</b></a></div>  时间: <fmt:formatDate value="${page.date}" pattern="yyyy-MM-dd"/>
					    </td>
					  </tr>
					  <tr>
