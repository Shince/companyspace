...
<div class="row-fluid custom round">
	...
	<div class="content">
		<div style="text-align: right;">
			<a href='<c:url value="/admin/competition/new"></c:url>' class="btn btn-primary pull-right mybtn">
				添加竞赛</a><br>
					...
					<c:forEach items="${page.content}" var="page">
						<tr>
							...
							<td align="center">
								 ...
								 <a class="btn btn-info" href='<c:url value="/admin/competition/edit/${page.id}"></c:url>'>修改</a>
								 <a class="btn btn-info" href='<c:url value="/admin/competition/view/${page.id}"></c:url>'>查看</a>	
							</td>
						</tr>
					</c:forEach>
				</tbody>
...
<div class="modal hide fade" id="deleteNewsPostModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-footer">
	    ...
	    <form action='<c:url value="/admin/competition/destory"></c:url>' method="post" style="display: inline-block;" >
