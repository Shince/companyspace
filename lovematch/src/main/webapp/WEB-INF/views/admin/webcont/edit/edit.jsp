...
<div class="row-fluid custom round">
	...
	<div class="content">
		<form action= "<c:url value='/admin/cont/edit/edit'></c:url>" enctype="multipart/form-data"   method="post" name="news_post" id="news_new_form"   >
			<input type="hidden" value="${cont.id }" name="cont_id" >
			
			<div class="control-group" id="title">
				<label class="control-label" for="title"><strong> 标题</strong></label>
				<div class="controls">
					<input type="text" name="title" placeholder="标题" value="${cont.title }"> <span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" id="type">				
				<div class="controls">
					<select name="type">
						<option value="gjxm" >国家项目</option>
			...
			<div class="control-group" id="content">
				<div class="controls">
					<textarea  style="width:80%;height:280px;"  name="content"  placeholder="内容">${cont.content }</textarea>
