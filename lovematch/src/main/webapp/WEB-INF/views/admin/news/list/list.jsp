...
<div class="row-fluid custom round">
	...
	<div class="content">
		<div style="text-align: right;">
			<a href='<c:url value="/admin/news/zhxw/list"></c:url>' class="btn btn-primary pull-left mybtn">
				综合新闻</a>
			<a href='<c:url value="/admin/news/hyzx/list"></c:url>'  class="btn btn-primary pull-left mybtn mysplit">
				行业资讯</a>
			<a href='<c:url value="/admin/news/yjdt/list"></c:url>' class="btn btn-primary pull-left mybtn mysplit">
				科研动态</a>
			<a href='<c:url value="/admin/news/add"></c:url>' class="btn btn-primary pull-right mybtn">
				添加内容</a><br>
			<table class="table table-bordered table-hover"  cellpadding="5" width=100%  border=0>
				<thead><tr>
						<th  align="center" width="150">${webBiz }图片</th>
						<th align="center" >
							新闻标题
						</th>
						<th   align="center" width="150">发布时间</th>
						<th  align="center" width="115">操作</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach items="${page.content}" var="page">
						<tr>
							...
							<td align="center">
								 ...
								 <a class="btn btn-info" href='<c:url value="/admin/news/edit/${page.id}"></c:url>'>修改</a>	
							</td>
						</tr>
					</c:forEach>
				</tbody>
...
<div class="modal hide fade" id="deleteNewsPostModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-footer">
	    ...
	    <form action='<c:url value="/admin/news/destory"></c:url>' method="post" style="display: inline-block;" >
	    	<input id="newsId" type="hidden" name="news_id" />
