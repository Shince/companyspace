...
<div class="row-fluid custom round">
	...
	<div class="content">
		<form action= "<c:url value='/admin/news/new'></c:url>"  method="post" name="news_post" id="news_new_form"  enctype="multipart/form-data"  onsubmit="return checkPicture(this)">
			...
			<div class="control-group" id="type">				
				<div class="controls">
					<select name="type">
						<option value="zhxw" selected="selected">综合新闻</option>
			...
			<div class="control-group" id="content">
				<div class="controls">
					<textarea  style="width:80%;height:280px;"  name="content"  placeholder="内容"></textarea>
